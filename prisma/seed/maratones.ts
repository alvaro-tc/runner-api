...
const MARATONES: SemillaMaraton[] = [
  ...
  {
    slug: 'carrera-10k-potosi-cerro-rico',
    name: 'Carrera 10K Potosi - Cerro Rico',
    description:
      '10K entre el centro colonial y la base del Cerro Rico, a 4.070 m sobre el nivel del mar. ' +
      'Perfil exigente por la altura, poco tecnico.',
    enDias: 20,
    horaLargada: 8,
    city: 'Potosi',
    distanceMeters: 10_000,
    ...
    cierraEnDias: 17,
    schedule: [
      { time: '07:00', title: 'Acreditacion' },
      { time: '08:00', title: 'Largada' },
      { time: '10:00', title: 'Premiacion' },
    ],
    includes: ['remera', 'medalla finisher', 'hidratacion'],
    kitPickup: null,
    lat: -19.5836,
    lng: -65.7531,
    categorias: [CATEGORIA_GENERAL, CATEGORIAS_POR_EDAD[2]!],
    extras: [{ name: 'Bolsa de corredor', priceCents: 4000, stock: 200 }],
  },
  {
    slug: 'maraton-cobija-amazonica',
    name: 'Maraton Amazonica de Cobija',
    description:
      '21K plano por la ribera del rio Acre, con humedad y calor tipicos del Pando. Largada muy ' +
      'temprano para correr las primeras horas con sombra.',
    enDias: 60,
    horaLargada: 6,
    city: 'Cobija',
    distanceMeters: 21_097,
    ...
    schedule: [
      { time: '05:00', title: 'Acreditacion' },
      { time: '06:00', title: 'Largada' },
      { time: '09:00', title: 'Premiacion' },
    ],
    includes: ['remera tecnica', 'medalla finisher', 'hidratacion'],
    kitPickup: null,
    lat: -11.0267,
    lng: -68.7692,
    categorias: [CATEGORIA_GENERAL],
    extras: [{ name: 'Foto profesional', priceCents: 6000, stock: null }],
  },
  {
    slug: 'nocturna-10k-villamontes',
    name: 'Nocturna 10K Villamontes',
    description:
      '10K nocturna por el chaco tarijeno, con temperatura mas fresca que de dia. Terreno plano y ' +
      'buena iluminacion en todo el recorrido.',
    enDias: 100,
    horaLargada: 19,
    city: 'Villamontes',
    distanceMeters: 10_000,
