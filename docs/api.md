...
GET    /admin/payments?marathonId=&status=&q=&page=&pageSize=  ← admin | organizer · los tickets, con `validatedBy`; `q` busca nombre, CI, celular, email, dorsal o nº de transacción
